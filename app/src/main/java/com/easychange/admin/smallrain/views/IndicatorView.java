...
public class IndicatorView extends LinearLayout {
    ...
    public int getSelctedPosition() {
        return selctedPosition;
    }

    public void setSelctedPosition(int selctedPosition) {
        this.selctedPosition = selctedPosition;
        removeAllViews();
        drawPoint();
    }
